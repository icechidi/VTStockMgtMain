...
import { AddStockItemDialogDatabase } from "@/components/stocks/add-stock-item-dialog-database"
import { CategoryManagementDatabase } from "@/components/stocks/category-management-database"
import { BarcodeScanner } from "@/components/stocks/barcode-scanner"
import { BarcodeGenerator } from "@/components/stocks/barcode-generator"
import { ItemLookupResult } from "@/components/stocks/item-lookup-result"
import { ItemNotFound } from "@/components/stocks/item-not-found"
...
function InventoryPageDatabaseInner() {
  ...
  const [filters, setFilters] = useState<ItemFilters>({
    ...
    category: "ALL",
    location: "ALL",
    stockStatus: searchParams.get("status") ?? "ALL",
    sortBy: "created_at",
    ...
    return (
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        <div className="flex items-center gap-4">
          <h2 className="text-xl font-semibold tracking-tight">Stock Items</h2>
        </div>
